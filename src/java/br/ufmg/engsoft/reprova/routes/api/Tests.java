...
public class Tests {
     ...
     * Logger instance.
     */
    protected static final Logger logger = LoggerFactory.getLogger(Tests.class);
     ...
     */
    protected final TestsDAO testsDAO;
     ...
     * @param testsDAO  the DAO for QuestionList
     * @throws IllegalArgumentException  if any parameter is null
     */
    public Tests(Json json, TestsDAO testsDAO) {
        if (json == null)
    ...
    protected static boolean authorised(String token) {
        return Tests.token.equals(token);
    }
...
//        }
        ...
        var success = testsDAO.remove(id);
